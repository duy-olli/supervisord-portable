 ...
 */
#ifndef _fist_monitorfs_h
#define _fist_monitorfs_h

/* OPTIONAL DECLARATIONS FOLLOW */


  /*
   * monitorfs: like lofs, modifies neither file names nor their data
   */

/* MACROS AND STRUCTURES BASED ON FIST FILE tests/monitorfs.fist */

/* Name of the file system? */
#define FIST_FSNAME "monitorfs"
